...
theme.titlebar_bg_focus                         = "#alpha"
theme.titlebar_bg_normal                        = "#alpha"
...
--[[
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            --arrow("#222222", "#497B96"),
            --wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "alpha"),
            --arrow("#497B96", "#777E76"),
            ...
            --arrow("#4B696D", "#8DAA9A"),
            -- wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "alpha"),
            --arrow("#8DAA9A", "#C0C0A2"),
            ...
            --arrow("#C0C0A2", "#777E76"),
            -- wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), "alpha"),
            --arrow("#777E76", "alpha"),
            --]]
            --s.mylayoutbox,
        --},
