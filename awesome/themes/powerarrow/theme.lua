...
theme.wallpaper                                 = theme.dir .. "wallpaper/0146.jpg"
...
theme.taglist_fg_focus                          = bright_magenta

theme.tasklist_bg_focus                         = black
theme.tasklist_fg_focus                         = blue

theme.border_width                              = dpi(2)
theme.border_normal                             = bright_black
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, blue, " " .. net_now.received .. " ↓↑ " .. net_now.sent .. " "))
    end
})
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(20), bg = black, fg = theme.fg_normal, visible = true, opacity = 1, }) --border_width = dpi(1), border_color = magenta })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow(black, black),
            wibox.container.background(wibox.container.margin(wibox.widget { volicon, theme.volume.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), black),
            arrow(black, black),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), black),
            arrow(black, black),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), black),
            --arrow("#4B696D", "#4B3B51"),
            ...
            arrow(black, black),
            wibox.container.background(wibox.container.margin(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), black),
            arrow(black, black),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), black),
            arrow(black, black),
            wibox.container.background(wibox.container.margin(clock, dpi(4), dpi(8)), black),
            arrow(black, black),
            --]]
            wibox.container.background(wibox.container.margin(s.mylayoutbox), black),
        },
    }
end
