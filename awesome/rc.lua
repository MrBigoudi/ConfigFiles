...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -i -nb '#282a36' -nf '#ff92d0' -sb '#caa9fa' -sf '#ffffff' -fn NotoMonoRegular:bold:pixelsize=14",
 ...
 -- Show/Hide Systray
    ...
    -- Brightness
    awful.key({ modkey1 }, "Up", function () os.execute("xbacklight -inc 10") end,
    --awful.key({ }, "XF86MonBrightnessUp", function () os.execute("xbacklight -inc 10") end,
              {description = "+10%", group = "hotkeys"}),
    awful.key({ modkey1 }, "Down", function () os.execute("xbacklight -dec 10") end,
